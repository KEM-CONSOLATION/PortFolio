      ...
      <div className=" max-w-5xl mx-auto">
        <div className=" grid grid-cols-1 mx-5 my-5 mt-10 md:flex md:items-center md:justify-between">
          <div className=" order-2 md:-order-none mt-10">
            ...
            <h1 className=" mt-10 text-5xl font-semibold text-blue-900">
            ...
            <div className=" mt-10 animate-bounce">
              <a
                ...
                target="_blank"
                className=" underline font-semibold text-blue-500 text-2xl"
              >
                View CV
              </a>
            </div>
          ...
          <div className=" flex flex-col items-center justify-center mb-10 md:mb-0 h-72 w-72 mx-auto md:mx-0 md:h-96 md:w-96 rounded-full bg-blue-600 relative">
            ...
            <div className=" animate-pulse shadow-2xl absolute bottom-0 right-0 bg-white rounded-full h-28 w-28 items-center flex justify-center text-blue-500">
              <NodeTreeIcon size={60} />
            </div>
            <div className=" animate-bounce shadow-2xl absolute left-[-40px] bottom-20 bg-white rounded-full h-28 w-28 items-center flex justify-center text-blue-500">
